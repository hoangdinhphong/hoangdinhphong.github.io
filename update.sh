...
apt-ftparchive packages ./Deb > ./Info/Win10Clock/Boss/Packages;
#sed -i -e '/^SHA/d' ./Packages;
bzip2 -c9k ./Info/Win10Clock/Boss/Packages > ./Info/Win10Clock/Boss/Packages.bz2;
echo "------------------"
echo "Đang tạo tệp Release...."
printf "Origin: Hoàng Đình Phong\nLabel: Hoàng Đình Phong\nSuite: stable\nVersion: 1.0\nCodename: ios\nArchitecture: iphoneos-arm\nComponents: main\nDescription: Hoàng Đình Phong\nMD5Sum:\n "$(cat ./Info/Win10Clock/Boss/Packages | md5sum | cut -d ' ' -f 1)" "$(stat ./Info/Win10Clock/Boss/Packages --printf="%s")" Packages\n "$(cat ./Packages.bz2 | md5sum | cut -d ' ' -f 1)" "$(stat ./Info/Win10Clock/Boss/Packages.bz2 --printf="%s")" Packages.bz2\n" >Release;
